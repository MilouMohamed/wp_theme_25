 ...
 *  the_excerpt 
 */
function medoxMil_numbring_pagination()
{

  global $wp_query;
  $all_pages = $wp_query->max_num_pages;//Tout les pages
  $curnt_page = max(1, get_query_var('paged'));// la page actuelle
  ...
  if ($all_pages > 1) {
    return paginate_links(array(
      ...
      'format' => 'page/%#%',
      'current' => $curnt_page,
      // 'total' => $all_pages, // par defaut et difiner le max 
      'min_size' => 2,
      'end_size' => 1,
    ));
